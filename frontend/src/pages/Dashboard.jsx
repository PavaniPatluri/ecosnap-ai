    ...
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">Keep up the sustainable lifestyle.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-700">Total Carbon</h3>
            <Cloud className="text-red-500 h-6 w-6" />
          </div>
          <p className="text-3xl font-bold text-gray-900">{totalCarbon} <span className="text-lg font-medium text-gray-500">kg CO₂</span></p>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-700">Total Water</h3>
            <Droplets className="text-blue-500 h-6 w-6" />
          </div>
          <p className="text-3xl font-bold text-gray-900">{totalWater} <span className="text-lg font-medium text-gray-500">L</span></p>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-700">Avg EcoScore</h3>
              <Leaf className="text-eco-500 h-6 w-6" />
            </div>
            <p className="text-3xl font-bold text-gray-900">{avgEcoScore} <span className="text-lg font-medium text-gray-500">/ 100</span></p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
          <h3 className="text-xl font-bold text-gray-900 mb-6">Recent Carbon Footprint</h3>
          <div className="h-64">
            ...
            {scans.slice().reverse().map(scan => (
              <div key={scan.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                ...
                <div className="text-right flex items-center">
                   <div className="bg-white px-3 py-1 rounded-full text-xs font-bold shadow-sm border border-gray-100 flex items-center">
                     <span className="text-eco-600 mr-1">Score:</span> {scan.eco_score}
                   </div>
                </div>
              </div>
            ))}
            {scans.length === 0 && <p className="text-gray-500 text-center py-8">No scans yet. Try scanning an item!</p>}
          </div>
        </div>
      </div>
    </div>
