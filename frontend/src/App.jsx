      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-black text-gray-900 tracking-tight">EcoSnap<span className="text-eco-600">AI</span></span>
          </div>
          <div className="flex items-center space-x-1 sm:space-x-4">
            ...
            <button onClick={handleLogout} className="text-red-500 hover:text-red-700 hover:bg-red-50 px-3 py-2 rounded-md text-sm font-medium flex items-center transition-colors">
